<footer id="contact_footer">
				<div>
					<p style="font-size:14px; color:#fff;">Contact details</p>
					<p>Phone: <a href="tel:+996771193280" target="_self" title="Tap to call.">+996(507)001014</a></p>
					<p>E-mail: <a href="mailto:Love-story888@mail.ru" target="_self" title="Click to send to e-mail">Love-story888@mail.ru</a></p><br>
					...
					<a href="https://wa.me/821077339107?text=
Hello!%20Я%20I%20am%20talking%20about%20the%20marriage%20agency." target="_blank"> <img id="whatsapp" src="images\contact\whatsapp_inactive.png" width="30px" height="auto" onmouseover='S_network_on("whatsapp_active")' onmouseout='S_network_off("whatsapp_inactive")'></a>
				</div>
				
				<div>
					<p style="font-size:14px; color:#fff;">Navigation</p>
					<p><a id="main_9" href="index_en.php" target="_self">Home</a></p>
					<p></p>
				</div>
				
				<div>
					<p style="font-size:14px; color:#fff;">About the site</p>
					<p>Love Story 2018 Copyright.<br>All rights reserved.</p>
					<p>Developer: <a href="mailto:t.jyrgal@mail.ru?subject=Question from the site&body=Hello webmaster" target="_self">Turgunbaev J.</a></p>
				</div>
